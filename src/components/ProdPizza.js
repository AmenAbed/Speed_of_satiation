...
class ProdPizza extends Component{
    render(){
        return(
                    <div className="col-md-4  col-sm-3 m-sm-2 col-6 m-3 m-lg-4 card bg-mycolor text-light rounded-0 cardpizza" style={{width: '220px', height: '300px'}} id={this.props.ID}>
